...
public class MyChatList extends AppCompatActivity implements ChatRoomAdapter.OnItemClickListener { //채팅방 리스트 불러오는 액티비티
            ...
            call.enqueue(new Callback<List<ChatRoom>>() {
                ...
                public void onResponse(Call<List<ChatRoom>> call, Response<List<ChatRoom>> response) { //응답
                    if (response.isSuccessful()) {
                        ...
                        adapter = new ChatRoomAdapter(MyChatList.this, chatRoomList);
                        adapter.setOnItemClickListener(MyChatList.this);
                        recyclerView.setAdapter(adapter);
                        recyclerView.setLayoutManager(new LinearLayoutManager(MyChatList.this));
                    }
                }

                @Override
                public void onFailure(Call<List<ChatRoom>> call, Throwable t) {
                    Toast.makeText(MyChatList.this, "채팅방을 불러오는데 실패했습니다.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void onItemClick(int position) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MyChatList.this);
    ...
    private void joinChatRoom(String roomId, String userId) {
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(MyChatList.this, "모임 가입이 완료되었습니다.", Toast.LENGTH_SHORT).show();
                    // 가입 성공 시 필요한 동작 수행
                    // 채팅방으로 이동
                    Intent intent = new Intent(MyChatList.this, ChatRoomActivity.class);
                    ...
                    Toast.makeText(MyChatList.this, "모임 가입에 실패했습니다.", Toast.LENGTH_SHORT).show();
                    // 가입 실패 시 필요한 동작 수행
                }
            }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(MyChatList.this, "서버 에러.", Toast.LENGTH_SHORT).show();
                // 가입 실패 시 필요한 동작 수행
            }
        });
    }
